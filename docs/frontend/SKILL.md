...
Cursor 入口：`.cursor/skills/edms-fe-governance/SKILL.md`（已配置）；编辑 `edms-ui/**` 时由 `.cursor/rules/edms-frontend.mdc` 自动注入。
...
位置: edms-ui/apps/web-app/src/api/system/user.ts:12
