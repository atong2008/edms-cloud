package com.edmscloud.edms.codegen.config;
...
@ConfigurationProperties(prefix = EdmsCodeGenDefaultProperties.PREFIX)
public class EdmsCodeGenDefaultProperties implements InitializingBean {

	public static final String PREFIX = "edms.codegen";
	 ...
	 * 生成代码的包名
	 */
	private String packageName = "com.edmscloud.edms";
