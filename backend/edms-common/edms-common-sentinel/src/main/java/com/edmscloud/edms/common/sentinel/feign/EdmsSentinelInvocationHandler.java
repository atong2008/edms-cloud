 ...
 */
@Slf4j
public class EdmsSentinelInvocationHandler implements InvocationHandler {
	...
	EdmsSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			EdmsSentinelInvocationHandler other = (EdmsSentinelInvocationHandler) obj;
