package com.edmscloud.edms.common.sentinel.feign;
 ...
 * @date 2020/6/9
 */
public final class EdmsSentinelFeign {

	private EdmsSentinelFeign() {

	}

	public static EdmsSentinelFeign.Builder builder() {
		return new EdmsSentinelFeign.Builder();
	}
	...
	public static final class Builder extends Feign.Builder implements ApplicationContextAware {
		...
		@Override
		public EdmsSentinelFeign.Builder contract(Contract contract) {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new EdmsSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new EdmsSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new EdmsSentinelInvocationHandler(target, dispatch);
				}
