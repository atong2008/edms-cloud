...
package com.edmscloud.edms.common.xss.core;

import cn.hutool.core.util.CharsetUtil;
import com.edmscloud.edms.common.xss.config.EdmsXssProperties;
import com.edmscloud.edms.common.xss.utils.XssUtil;
...
public class DefaultXssCleaner implements XssCleaner {
	...
	private final EdmsXssProperties properties;
	...
	public String clean(String bodyHtml) {
		...
		EdmsXssProperties.Mode mode = properties.getMode();
		if (EdmsXssProperties.Mode.escape == mode) {
			// html 转义
