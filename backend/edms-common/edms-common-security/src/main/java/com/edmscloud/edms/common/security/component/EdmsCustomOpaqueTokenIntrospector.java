package com.edmscloud.edms.common.security.component;

import cn.hutool.core.util.StrUtil;
import com.edmscloud.edms.admin.api.entity.SysApiKey;
import com.edmscloud.edms.admin.api.feign.RemoteApiKeyService;
...
import com.edmscloud.edms.common.core.util.SpringContextHolder;
import com.edmscloud.edms.common.core.util.WebUtils;
import com.edmscloud.edms.common.security.service.EdmsDefaultUserDetailsServiceImpl;
import com.edmscloud.edms.common.security.service.EdmsUser;
import com.edmscloud.edms.common.security.service.EdmsUserDetailsService;
...
public class EdmsCustomOpaqueTokenIntrospector implements OpaqueTokenIntrospector {
	...
	public OAuth2AuthenticatedPrincipal introspect(String token) {
		...
		if (AuthorizationGrantType.CLIENT_CREDENTIALS.equals(oldAuthorization.getAuthorizationGrantType())) {
			return new EdmsClientCredentialsOAuth2AuthenticatedPrincipal(
		...
		Map<String, EdmsUserDetailsService> userDetailsServiceMap = SpringContextHolder
			.getBeansOfType(EdmsUserDetailsService.class);

		Optional<EdmsUserDetailsService> optional = userDetailsServiceMap.values()
			.stream()
		...
		try {
			...
			userDetails = optional.get().loadUserByUser((EdmsUser) tokenPrincipal);
		}
		...
		// 注入客户端信息，方便上下文中获取
		EdmsUser pigUser = (EdmsUser) userDetails;
	...
	private OAuth2AuthenticatedPrincipal handleApiKeyToken(String token) {
		...
		UserDetails userDetails = SpringContextHolder.getBean(EdmsDefaultUserDetailsServiceImpl.class)
			.loadUserByUsername(apiKey.getUsername());
		if (!(userDetails instanceof EdmsUser pigUser)) {
