...
package com.edmscloud.edms.common.log.event;
...
public class SysLogListener implements InitializingBean {
	...
	private final EdmsLogProperties logProperties;
	...
	public void afterPropertiesSet() {
		...
		JacksonSensitiveFieldUtil.registerCustomModule(new EdmsJavaTimeModule());
	}
