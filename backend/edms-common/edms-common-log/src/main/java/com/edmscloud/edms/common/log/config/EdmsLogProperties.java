...
package com.edmscloud.edms.common.log.config;
...
@Getter
@Setter
@ConfigurationProperties(EdmsLogProperties.PREFIX)
public class EdmsLogProperties {

	public static final String PREFIX = "edms.log";
