package com.edmscloud.edms.auth.support.core;

import cn.hutool.core.util.StrUtil;
import cn.hutool.extra.spring.SpringUtil;
import com.edmscloud.edms.auth.support.filter.AuthSecurityConfigProperties;
 ...
 * @since 1.0.0
 */
public class EdmsDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	 ...
	 */
	public EdmsDaoAuthenticationProvider() {
	...
	protected void additionalAuthenticationChecks(UserDetails userDetails,
		...
		if (configProperties.isExpirePassword() && userDetails instanceof EdmsUser pigUser
	 ...
	 * null
	 * @see EdmsUserDetailsService#support(String, String)
	 */
	@SneakyThrows
	@Override
	protected final UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken authentication) {
		...
		Map<String, EdmsUserDetailsService> userDetailsServiceMap = SpringUtil
