package com.edmscloud.edms.auth.support.base;

import cn.hutool.core.util.BooleanUtil;
import cn.hutool.extra.spring.SpringUtil;
import com.edmscloud.edms.common.core.constant.CommonConstants;
import com.edmscloud.edms.common.security.service.EdmsRedisOAuth2AuthorizationService;
import com.edmscloud.edms.common.security.util.OAuth2ErrorCodesExpand;
import com.edmscloud.edms.common.security.util.ScopeException;
...
public abstract class OAuth2ResourceOwnerBaseAuthenticationProvider<T extends OAuth2ResourceOwnerBaseAuthenticationToken>
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		try {
			...
			EdmsRedisOAuth2AuthorizationService redisOAuth2AuthorizationService = (EdmsRedisOAuth2AuthorizationService) this.authorizationService;
